...
/*
 *
 *  * Copyright (c) 2018 Philipp Elvin Friedhoff on 28.11.18 17:38
 *
 */
...
public class DesignSettingsPage extends PrivateGUI {

    public DesignSettingsPage(Player owner) {
        super("designSettings", owner);
    }
